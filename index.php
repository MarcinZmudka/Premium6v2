        ...
        <div class="carousel-inner">
          <div class="carousel-item active" data-interval="5000">
            ...
            <div class="carousel-caption d-none d-md-block ">
              ...
              <p>
                <h4>Rozejrzyj się na naszej stronie i dowiedz się wiecej o naszym apartamencie</h4>
              </p>
            </div>
          ...
          <div class="carousel-item" data-interval="5000">
            ...
            <a href="apartament.php">
              <div class="carousel-caption d-none d-md-block ">
                <h1>Pooglądaj nasz Apartament</h1>
                <p>
                  <h4>Tutaj dowiesz się wiecej o tym co nasz Apartament ma do zaoferowania</h4>
                </p>
              </div>
              <div class="carousel-caption d-block d-sm-none">
                <h3>Pooglądaj nasz Apartament</h3>
              </div>
            </a>
          </div>
          <div class="carousel-item" data-interval="5000">
            ...
            <a href="atrakcje.php">
              <div class="carousel-caption d-none d-md-block ">
                <h1>Zobacz co ciekawego czeka na Ciebie w Białce Tatrzańskiej</h1>
                <p>
                  <h4>Białka Tatrzańska to nie tylko termy ale i ..</h4>
                </p>
              </div>
              <div class="carousel-caption d-block d-sm-none">
                <h3>Zobacz co ciekawego czeka na Ciebie</h3>
              </div>
            </a>
          ...
          <div class="carousel-item" data-interval="5000">
            ...
            <a href="kontakt.php">
              <div class="carousel-caption d-none d-md-block ">
                <h1>Masz pytanie ? Tutaj uzyskasz odpowiedź</h1>
                <p>
                  <h4>Uzyskaj informacje na temat cen, dostępnych terminów oraz wskazówek dojazdu!</h4>
                </p>
              </div>
              <div class="carousel-caption d-block d-sm-none">
                <h3>Masz pytanie ? Tutaj uzyskasz odpowiedź</h3>
              </div>
            </a>
          </div>
        </div>
    ...
    <div class="container py-3">
      <div class="row justify-content-center">
        ...
        <div class="col-md-6 booktext">
          <p class="text"><span class="title">Zostaliśmy odznaczeni!</span><br>
            Jest nam bardzo miło oznajmić, że serwis Booking.com odznaczył nas nagrodą za wysoką średnią ocen
            otrzymanych od naszych gości wynoszącą 9.5/10 punktów. Dziękujemy!
          </p>
        </div>
      </div>
    </div>
    <div class="jumbotron mb-0 mt-4 pt-4 py-4">
      <div class="container">
        ...
        <div class="row marks my-4 ">
          ...
          <div class="col">
            <h5><strong>Monika z Booking.com</strong></h5><br>„Najbardziej podobało nam się, ze obiekt był świetnie
